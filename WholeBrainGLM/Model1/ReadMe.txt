...
This model is designed to assess the differences between the three tasks. It should be compared to model 2 (same as this but without a diff regressor) and model 3 (same as this but uses the distance measure as Value).
