...
def valueLookup(itemRank,itemValueDF):
    if itemRank == 0 :
        ...
        value = itemValueDF[itemValueDF.index == str(itemRank)].CSBValue_ParamEXT
    return value
...
def extValueLookup(trialType,itemValueDF):
    if trialType == 0:
        ...
        value = 1*(itemValueDF[itemValueDF.index == "scalingXT"].CSBValue_ParamEXT)
    elif trialType == 5:
        value = 2*(itemValueDF[itemValueDF.index == "scalingXT"].CSBValue_ParamEXT)
    elif trialType == 6:
        value = 3*(itemValueDF[itemValueDF.index == "scalingXT"].CSBValue_ParamEXT)
    elif trialType == 7:
        value = 1*(itemValueDF[itemValueDF.index == "bundlingXT"].CSBValue_ParamEXT)
    elif trialType == 8:
        value = 2*(itemValueDF[itemValueDF.index == "bundlingXT"].CSBValue_ParamEXT)
    elif trialType == 9:
        value = 3*(itemValueDF[itemValueDF.index == "bundlingXT"].CSBValue_ParamEXT)
    return value
