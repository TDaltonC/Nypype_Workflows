...
Value Model -- This model uses a Drift diffusion model to assess the drift rate of each option. The drift-Rate of each option is asumed to be drawn from the same distribution for all subjects. The value of each option is asumed to be ln(optionDriftRate).
